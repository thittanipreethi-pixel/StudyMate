...
# This allows any *.onrender.com subdomain
import os
if 'RENDER' in os.environ or any('.onrender.com' in host for host in ALLOWED_HOSTS):
    # Add wildcard for Render domains
    if '*' not in str(ALLOWED_HOSTS):
