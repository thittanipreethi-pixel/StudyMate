...
const loginMotivations = [
  {
    title: "Welcome Back!",
    description: "Continue your learning journey with StudyMate. Access all your study materials in one place.",
    icon: "🎓"
  },
  {
    title: "Your Success Starts Here",
    description: "Join thousands of students who are achieving their academic goals with StudyMate.",
    icon: "🚀"
  },
  {
    title: "Organized Learning",
    description: "Find notes, question papers, and study materials organized by department, year, and semester.",
    icon: "📚"
  },
  {
    title: "Study Smart, Not Hard",
    description: "Access quality study materials anytime, anywhere. Your academic companion is here.",
    icon: "💡"
  },
  {
    title: "Stay Ahead",
    description: "Get instant access to the latest study materials and stay ahead in your academics.",
    icon: "⭐"
  }
]
...
function Login() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await api.login(null, formData.email, formData.password)
      
      localStorage.setItem('accessToken', response.access)
      localStorage.setItem('refreshToken', response.refresh)
      localStorage.setItem('isAuthenticated', 'true')
      localStorage.setItem('userRole', response.role || 'student')
      localStorage.setItem('username', response.username || 'Student')
        ...
        <div className="w-full lg:w-1/2 flex items-center justify-center p-8">
          <div className="w-full max-w-md space-y-8">
            <div className="text-center lg:text-left">
              ...
              <p className="text-gray-600">Sign in to your StudyMate account</p>
            </div>
